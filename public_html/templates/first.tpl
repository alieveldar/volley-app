...
<div class="tab-content" id="myTabContent">
  ...
  <div class="mytable"><table>{TRAINING_ROOM_TABLE}</table></div></div>
    ...
    <table>
      ...
      <tr>
        ...
        <td  class="btn btn-link" data-toggle="modal" data-target="#exampleModal" style="display: block; height: 100%;">
            ...
            <div>
              <img src="https://lvh.me/assets/img/rooms/central.jpg" alt="..." class="rounded-circle" style="width: 75px; height: 75px;">
            </div>
            <div>
              <p>$rooom_adress</p>
            </div>
