...
INSERT INTO `news` (`id`, `title`, `text`, `images`, `href`, `arch`) VALUES
...
INSERT INTO `roots` (`id`, `first_name`, `last_name`, `id_vk`, `role`, `arch`) VALUES
(1, 'Эльдар1', 'Алиев1', 39891999, 1, 0),
(2, 'Пишу', 'Приложение', 514842413, 1, 0);
...
INSERT INTO `training` (`id`, `trainer`, `volley_room`, `date`, `day_of_week`, `start_time`, `duration`, `capacity`, `level`, `repeatability`, `price`, `arch`) VALUES
(17, 2, 1, '2018-12-30', 7, '00:10:00', 0, 20, 2, 0, 2003, 0),
(18, 2, 1, '2018-12-03', 1, '22:10:00', 0, 20, 4, 0, 2003, 1),
(21, 2, 1, '2018-12-03', 1, '00:10:00', 0, 20, 1, 0, 2003, 1),
(23, 2, 1, '2018-12-12', 3, '00:10:00', 0, 20, 2, 0, 2003, 0),
(24, 2, 2, '2018-12-03', 1, '22:10:00', 0, 4, 4, 0, 2003, 0),
(25, 2, 1, '2018-12-03', 1, '12:10:00', 0, 20, 4, 0, 2003, 0),
(26, 2, 1, '2018-12-03', 1, '12:20:00', 0, 20, 4, 0, 2003, 0),
(27, 2, 1, '2018-12-03', 1, '14:21:00', 0, 20, 4, 0, 2003, 0),
(28, 2, 3, '2018-12-27', 4, '18:10:00', 0, 20, 4, 0, 2003, 0),
(29, 2, 1, '2018-12-28', 5, '13:10:00', 0, 20, 4, 0, 2003, 0);
...
INSERT INTO `training_level` (`id`, `description`, `intensity`, `arch`) VALUES
(1, 'Нападение', 'Стандарт', 0),
(2, 'Курс Начинающие', 'Стандарт', 0),
(3, 'Курс Связующие', 'Стандарт', 0),
(4, 'Командная', 'MIDLE', 0),
(5, 'Подача', 'low', 0),
(6, 'Прием-Защита', 'low', 0),
(7, 'Турнир', 'high', 0),
(8, 'Игровая', 'low', 0);
...
(299, 14944443, 'Кристина', 'Александрова', 0, '', 0, 0, 1, 'https://pp.userapi.com/c846321/v846321672/ec402/yOBQvS5rRgs.jpg?ava=1'),
...
INSERT INTO `volley_room` (`id`, `name`, `city`, `adress`, `gps_longitude`, `gps_latitude`, `image`, `ya_map`, `arch`) VALUES
(1, 'Центральный стадион', 'Казань', 'ул. Ташаяк, 2А', 0, 0, 'assets/img/rooms/central.jpg', '<iframe src="https://yandex.ru/map-widget/v1/-/CBRIYPr6WC" width="560" height="400" frameborder="1" allowfullscreen="true"></iframe>', 0),
(2, 'Казань Арена', 'Казань', 'просп. Ямашева, 115А, Казань', 0, 0, 'https://lvh.me/assets/img/rooms/central.jpg', '645', 0),
(3, 'Каи Олимп', 'Казань', 'Чистопольская ул., 67, Казань\r\n', 0, 0, 'https://lvh.me/assets/img/rooms/central.jpg', '', 0),
(4, 'Динамо', 'Казань', 'ул. Максима Горького, 10А, Казань\r\n', 0, 0, 'assets/img/rooms/central.jpg', '', 0);
